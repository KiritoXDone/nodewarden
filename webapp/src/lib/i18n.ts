...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    txt_bind_yubikey: "Bind YubiKey",
    txt_unbind: "Unbind",
    txt_disable_yubikey: "Disable YubiKey",
    txt_yubikey_bound: "YubiKey bound",
    txt_yubikey_bind_failed: "Bind YubiKey failed",
    txt_refresh: "Refresh",
    ...
    txt_yubikey_is_enabled_for_this_account: "YubiKey OTP is enabled for this account.",
    txt_yubikey_otp: "YubiKey OTP",
    txt_one_of_my_keys_supports_nfc: "One of my keys supports NFC",
    txt_touch_yubikey_to_fill_otp: "Touch YubiKey to fill OTP",
    txt_master_password_required_to_unbind_or_disable_yubikey: "Master password is required to unbind or disable YubiKey.",
    txt_two_factor_method: "Two-factor method",
    txt_two_factor_verify_failed: "Two-factor verify failed",
...
const zhCNOverrides: Record<string, string> = {
  ...
  txt_bind_yubikey: '绑定 YubiKey',
  txt_unbind: '解绑',
  txt_disable_yubikey: '停用 YubiKey',
  txt_yubikey_bound: 'YubiKey 已绑定',
  txt_yubikey_bind_failed: '绑定 YubiKey 失败',
  ...
  txt_yubikey_is_enabled_for_this_account: '此账户已启用 YubiKey OTP。',
  txt_yubikey_otp: 'YubiKey OTP',
  txt_one_of_my_keys_supports_nfc: '我的某个密钥支持 NFC',
  txt_touch_yubikey_to_fill_otp: '触摸 YubiKey 自动填入 OTP',
  txt_master_password_required_to_unbind_or_disable_yubikey: '解绑或停用 YubiKey 需要输入主密码。',
  txt_two_factor_method: '两步验证方式',
  txt_total_items_count: '共 {count} 项',
  txt_totp_verify_failed: 'TOTP 验证失败',
  txt_two_factor_verify_failed: '两步验证失败',
