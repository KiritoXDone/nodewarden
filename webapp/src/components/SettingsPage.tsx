...
export default function SettingsPage(props: SettingsPageProps) {
  ...
  useEffect(() => {
    setYubikeyNfc(props.yubikeyNfcEnabled);
  }, [props.yubikeyNfcEnabled]);
            ...
            <div className="settings-subcard">
              ...
              <label className="check-line" style={{ marginBottom: 12 }}>
                <input
                  type="checkbox"
                  checked={yubikeyNfc}
                  onChange={(e) => setYubikeyNfc((e.currentTarget as HTMLInputElement).checked)}
                />
                <span>{t('txt_one_of_my_keys_supports_nfc')}</span>
              </label>
              <div className="actions">
                <button
                  type="button"
